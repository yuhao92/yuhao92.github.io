...
.bracketed-list > li {
  ...
  margin-bottom: 1em;
  position: relative;
  padding-left: 2.5em;   /* reserve space for the [n] label */
}
...
.bracketed-list > li::before {
  ...
  left: 0;
  top: 0;
  width: 2.1em;          /* aligns bracket number; tweak if hitting [10]+ */
  text-align: right;
  font-weight: 600;
}

/* For the unordered list variant (e.g., patents), keep the same hanging indent look */
.bracketed-list.unordered > li::before {
  content: "•";
  width: 1.2em;
  text-align: center;
  font-weight: 700;
...
/* Inline link styling and metadata blocks */
.bracketed-list a {
  text-decoration: none;
}

.bracketed-list > li > p {
  margin: 0;             /* tighter spacing inside items */
}
...
See my <a href="https://scholar.google.com/citations?user=a_Lmc8AAAAAJ&hl=en&oi=ao">Google Scholar</a> for an up-to-date publication list.
...
<div class="infoblock">
  ...
  <div class="blockcontent">
    <ol class="bracketed-list">
      ...
      <li>
        <p>
          <a href="https://doi.org/10.1109/TMECH.2026.3686693"><b>Vibration of Soft, Twisted Beams for Under-Actuated Quadrupedal Locomotion</b></a>.<br>
...
<div class="infoblock">
  <div class="blocktitle"></div>
  <div class="blockcontent">
    <!-- Use an unordered list but keep hanging indent styling with bullets -->
    <ul class="bracketed-list unordered">

      <li>
        <p>
          <a href="https://www.freepatentsonline.com/y2024/0391542.html"><b>Tunable Motion Using Flexible Twisted Beams</b></a>.<br>
          D. Aukes, <b>Y. Jiang</b>, F. Chen — US Patent Application 20240391542
        </p>
      </li>
