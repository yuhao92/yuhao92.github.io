...
My research focuses on reconfigurable modular robotic systems that adapt their morphology and collective organization to changing tasks and environments. I study the co-design of mechanism, morphology, sensing, and control across two coupled scales. At the module level, I develop compliant and multistable mechanisms that exploit nonlinear mechanics to achieve multiple behaviors with few actuators. At the system level, I investigate physical cooperation, self-reconfiguration, and embodied planning in multi-module robots. My work combines analytical and computational modeling, dynamic simulation, optimization, and experiments with physics-informed and AI-enabled control and planning. The overarching goal is to establish principles for robots whose morphology is an active decision variable, enabling energy-efficient, robust, and versatile locomotion and manipulation in uncertain environments. I also mentor students in the design, modeling, fabrication, control, and experimental evaluation of robotic systems.
</p>
